...
Подборка намеренно короткая: в исходных папках больше 80 изображений, но для портфолио лучше использовать только самые показательные артефакты.
...
<img src="../D01_Linux.ID_356272-1/src/img/3_6_2.png" alt="Статическая настройка сети через netplan" width="720">
...
<img src="../D01_Linux.ID_356272-1/src/img/8_2.png" alt="Проверка SSH-порта через netstat" width="720">
...
<img src="../D01_Linux.ID_356272-1/src/img/htop_cpu.png" alt="Мониторинг процессов через htop" width="720">
...
<img src="../D01_Linux.ID_356272-1/src/img/14_2.png" alt="Событие рестарта SSH в логах" width="720">
...
<img src="../D01_Linux.ID_356272-1/src/img/15_2.png" alt="Проверка выполнения cron-задачи в логах" width="720">
...
<img src="../DO2_LinuxNetwork.ID_356275-2/src/img/2_2_1.png" alt="Проверка статической маршрутизации между VM" width="720">
...
<img src="../DO2_LinuxNetwork.ID_356275-2/src/img/3_2.png" alt="Измерение скорости соединения через iperf3" width="720">
...
<img src="../DO2_LinuxNetwork.ID_356275-2/src/img/4_2.png" alt="Проверка firewall-поведения через ping и nmap" width="720">
...
<img src="../DO2_LinuxNetwork.ID_356275-2/src/img/5_4_1.png" alt="Таблицы маршрутизации на роутерах" width="720">
...
<img src="../DO2_LinuxNetwork.ID_356275-2/src/img/6_3.png" alt="DHCP-настройка и fixed-address по MAC" width="720">
...
<img src="../DO2_LinuxNetwork.ID_356275-2/src/img/7_5.png" alt="Проверка NAT через telnet и Apache" width="720">
